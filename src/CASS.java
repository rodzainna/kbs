...
public class CASS {
	...
	public String HighestCredit(){
		...
		System.out.println("Enter Courses Passed: Enter \"Done\" when you're done.");
		...
		ArrayList<String> eng_subjects    = new ArrayList<String>( Arrays.asList( "ENG1", "HUM1", "FIL1", "POLSCI4", "PSYCH1", "HIST1", "MATH1", "PE1", "NSTP1", "ENG2", "ENG3", "FIL3", "HIST3", "PHILIO1", "SOCIO1", "MATH31", "PE2", "NSTP2", "LIT1", "ENG5", "ENG7", "ENG25", "HIST5", "BIO1", "ECON1", "PE3", "LIT2", "ENG8", "ENG30", "IT100", "NATSCI1", "COGNATE1", "PE4", "ENG40", "ENG50", "ENG55", "ENG60", "ENG80", "ENG85", "ENGELECT1", "ENG35", "ENG45", "ENG65", "ENG70", "ENG90", "COGNATE2", "ENGELECT2", "ENG198") );
		...
		*/
		...
		if( ! probability.isEmpty() ) {
			...
			if( probability.get( 0 ).equalsIgnoreCase(prev_course)) {
				course = probability.get( 1 );
			} else {
				course = probability.get( 0 );
			}
		} else{
			course = "No Course";
		}
